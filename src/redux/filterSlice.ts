...
export interface IGridFilter {
    ...
    minDate?: string //necessary for new arrivals section
  }
...
export const initialState: IFilterState = [
    ...
    { gridID: "grid2", title: "Maybelline mascaras", fetchParams: {product_type: "Mascara", brand: "Maybelline"}, minDate: "5/2/2015"},
